...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.geometry("1200x750") # Increased height slightly for new input
    ...
    def create_sidebar(self):
        """Creates the left sidebar menu with input controls."""
        self.sidebar_frame = ctk.CTkFrame(self, width=220, corner_radius=0)
        self.sidebar_frame.grid(row=0, column=0, sticky="nsew")
        self.sidebar_frame.grid_rowconfigure(10, weight=1) # Pushes footer to bottom
        ...
        sub_label = ctk.CTkLabel(self.sidebar_frame, text="Structural Analysis", 
                                       text_color="gray")
        ...
        # Entry for Normal Force (Default is empty, handled in logic)
        ...
        self.lbl_file.grid(row=8, column=0, padx=20, pady=(20, 0), sticky="w")
    ...
    def create_main_area(self):
        """Creates the right main area with Tabs."""
    ...
    def calculate_event(self):
        ...
        n_force_str = self.entry_n_force.get() # Get normal force string

        if not filepath:
            messagebox.showwarning("Input Error", "Please select a DXF file first.")
            return

        # Handle Normal Force Input (Validation & Default)
        try:
        ...
        # Convert kN to N (Library uses Newtons)
        ...
        try:
            ...
            # --- PLOT GEOMETRY IMMEDIATELY ---
            print("Plotting geometry preview...")
            self.plot_geometry_embedded(section)
            self.update()

            # 5. Execute Calculation
            # We pass the converted 'n_force_newtons' to the parameter 'n'
    ...
    def plot_results_embedded(self, results_obj, n_val):
        ...
        # Update Title to show the Normal Force used
